...
async function buscaCharada() {
    try {
        ...
        const baseUrl = 'https://api-charadas-two.vercel.app'
        ...
        campoPergunta.textContent = "Erro ao conectar com o servidor! Tente novamente mais tarde"
...
btnPular.addEventListener('click', buscaCharada) // btn para pular a charada caso a pessoa nao goste

let contador = 0 // contador de quantas charadas ja foram vistas

function contarCharadas(){
    contador++
    document.getElementById("contador").textContent = contador
}

btnNova.addEventListener("click", contarCharadas)